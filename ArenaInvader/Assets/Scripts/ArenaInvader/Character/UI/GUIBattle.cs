...
public class GUIBattle : GUINetworkPopUp<int>
{
    ...
    [SerializeField] private Text _damageTarget;
    [SerializeField] private string _damageFormat = "{0}";
    ...
    private void AttackerAttack()
    {
        ...
        AttackSequence(_attackerImg, _targetImg,
            _attacker, _target,
            (damage) =>
            {
    ...
    private void TargetAttack()
    {
        ...
        AttackSequence(_targetImg, _attackerImg,
            _target, _attacker,
            (damage) =>
            {
                _attacker.TakeDamage(damage);
    ...
    protected void AttackSequence(Image attackerImg, Image targetImg, IStatus attacker, IStatus target, Action<int> callback)
    {
    ...
    public override void Close()
    {
        ...
        GameManager.Instance.Playground.CheckGameEnd();
    }
}
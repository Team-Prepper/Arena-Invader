...
public class D6Dice : IDice
{
    ...
    public override void Shot(float value, Action<int> callback = null) {
        ...
        rb.AddForce(InsideUnitSphere * _rand.Next(5, 10), ForceMode.Impulse);
        rb.AddTorque(InsideUnitSphere * RandomRange(torqueMin, torqueMax), ForceMode.Impulse);
